...
# Disaster Recovery Project — Task Bundles

## Task Bundle 1: Laundry + High Impact Declutter
**Estimated Time**: 1.75 hours (105 minutes)

### Subtasks + Time Estimates
1. Remove all dirty laundry from Mimir’s Room — 10 minutes  
2. Sort all laundry piles in Laundry Hall (clean vs dirty) — 15 minutes  
3. Start first load of laundry (includes staging for next load) — 15 minutes  
4. Remove dirty laundry from Cy’s Room — 10 minutes  
5. Empty trash bins (bathroom, kitchen, diaper) — 15 minutes  
6. Quick sweep/tidy of Laundry Hall floor — 10 minutes  
7. Buffer for interruptions or kid assistance — 30 minutes

---

## Task Bundle 2: Bathroom + Changing Station Deep Clean
**Estimated Time**: 1.5 hours (90 minutes)

### Subtasks + Time Estimates
1. Sanitize bathroom sink, toilet, and tub — 25 minutes  
2. Sanitize Mimir’s changing table — 10 minutes  
3. Wipe mirrors and remaining surfaces — 10 minutes  
4. Remove clutter and dirty towels from bathroom — 10 minutes  
5. Restock bathroom supplies — 10 minutes  
6. Quick sweep/mop of bathroom floor — 10 minutes  
7. Buffer for interruptions or organizing delay — 15 minutes

---

## Task Bundle 3: Dishes + Surface Reset
**Estimated Time**: 1.5 hours (90 minutes)

### Subtasks + Time Estimates
1. Wash and put away all dishes — 35 minutes  
2. Clear and sanitize kitchen counters — 10 minutes  
3. Clean kitchen sink and wipe down stove — 10 minutes  
4. Wipe washer/dryer surfaces — 10 minutes  
5. Start trash/pantry/fridge scan for expired items — 10 minutes  
6. Quick sweep of kitchen floor — 5 minutes  
7. Buffer for drying, distractions, and adjustments — 10 minutes

---

## Task Bundle 4: Toy Sorting Circuit
**Estimated Time**: 1.75 hours (105 minutes)

### Subtasks + Time Estimates
1. Sort toys in Cy’s Room (keep/store/donate) — 30 minutes  
2. Sort toys in Mimir’s Room — 25 minutes  
3. Sort toys in Living Room — 25 minutes  
4. Consolidate sorted piles / prep donate bag or storage bin — 10 minutes  
5. Buffer for distraction, kid conversations, clean-up transitions — 15 minutes

---

## Task Bundle 5: Bedroom & Floor Reset
**Estimated Time**: 2 hours (120 minutes)

### Subtasks + Time Estimates
1. Clear all floor clutter and visible trash — 20 minutes  
2. Remove loose laundry (clean or dirty) — 10 minutes  
3. Make the bed with fresh bedding — 10 minutes  
4. Clear and wipe down all surfaces (nightstands, dressers, etc.) — 20 minutes  
5. Sort miscellaneous items (bags, cords, papers) — 25 minutes  
